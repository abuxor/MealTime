...
function Page({ searchParams }: any) {
  return (
    <Card shadow="lg">
      ...
      <CardBody>
        <Banner
          title="Generate Recipe with Meal AI!"
          subtitle="Meal AI can help you generate the recipe you want from your text description"
        >
          <Chat
            builtInPrompts={[
              {
                name: "Can you get me insight into my meal plan?",
                content: "What is the size of the world?"
              },
            ]}
          />
        </Banner>
        <Suspense
          ...
          fallback={<RecipeListPlaceholder />}
        >
